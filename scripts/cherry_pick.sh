...
#TEST_SRC=../cs_data/my_test.cs
MODEL_PATH=/local-scratch/pooya/attention_regularization/aacl/de/1/restart/model_step_1000.pt
...
python ../OpenNMT-py/translate.py -output cherry.txt -model $MODEL_PATH -src $TEST_SRC -gpu 1 -batch_size 64 -beam_size 1 -attn_debug #-beam_size 5 #-beam_size 1
