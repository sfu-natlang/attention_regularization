...
#TRAIN_FROM=/local-scratch/pooya/attention_regularization/cs-en/baseline/3/model_step_10000.pt
TRAIN_FROM=/local-scratch/pooya/attention_regularization/aacl/cs/1/baseline/model_step_10000.pt
MODEL_PATH=/local-scratch/pooya/attention_regularization/aacl/cs/1/restart/model
